    ...
    <header className="bg-[var(--white-color)] min-h-[70px] p-4 flex items-center justify-between" dir={dir}>
      <div className="container m-auto">
        <div className="flex items-center justify-between">
          ...
          <bdi>
            <button onClick={() => handleChangeLang(i18n.language === 'en' ? 'ar' : 'en')} className="lang flex items-center gap-2 text-[#222]">
              ...
              <span className='lang-toggler text-base'>{t('header.lang')}</span>
            </button>
          </bdi>
        </div>
      </div>
